...
public class CrystallizerScreen extends AbstractContainerScreen<CrystallizerMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FHModMain.MOD_ID,"textures/gui/crystallizer/crystallizer_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FHModMain.MOD_ID,"textures/gui/crystallizer/arrow_progress.png");
