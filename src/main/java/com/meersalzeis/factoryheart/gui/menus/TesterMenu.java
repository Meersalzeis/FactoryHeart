...
public class TesterMenu  extends AbstractContainerMenu {
    public final TesterBlockEntity blockEntity;
    ...
    public TesterMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.TESTER_MENU.get(), pContainerId);
