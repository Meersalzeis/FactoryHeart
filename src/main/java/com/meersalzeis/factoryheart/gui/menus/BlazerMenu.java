...
public class BlazerMenu  extends AbstractContainerMenu {
    public final BlazerBlockEntity blockEntity;
    ...
    public BlazerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.BLAZER_MENU.get(), pContainerId);
        blockEntity = ((BlazerBlockEntity) entity);
