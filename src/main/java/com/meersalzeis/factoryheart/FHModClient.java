...
@Mod(value = FHModMain.MOD_ID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = FHModMain.MOD_ID, value = Dist.CLIENT)
public class FHModClient {
    public FHModClient(ModContainer container) {
    ...
    public static void debugMessageToAll(String message, boolean actionBar) {
        ...
        player.displayClientMessage(Component.literal(message), actionBar // false = chat, true = action bar
        );
    }
}
